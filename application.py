...
def getDataFromDB():
    params = parse.quote_plus("Driver={unixODBC};Server=tcp:recipe4medbserver.database.windows.net,1433;Database=Recipe4Me_db;Uid=recipe4me;Pwd={password@123};Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;")
